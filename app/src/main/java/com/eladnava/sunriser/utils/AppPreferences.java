...
public class AppPreferences {
    ...
    public static int getMiLightZone(Context context) {
        ...
        return Integer.parseInt(SingletonServices.getSharedPreferences(context).getString(context.getString(R.string.zone_pref), context.getString(R.string.zone_default)));
    }

    public static int getSunriseColor(Context context) {
        // Get color from SharedPreferences and convert to int
        return Integer.parseInt(SingletonServices.getSharedPreferences(context).getString(context.getString(R.string.sunrise_color_pref), context.getString(R.string.sunrise_color_default)));
    }

    public static int getMoonlightColor(Context context) {
        // Get color from SharedPreferences and convert to int
        return Integer.parseInt(SingletonServices.getSharedPreferences(context).getString(context.getString(R.string.moonlight_color_pref), context.getString(R.string.moonlight_color_default)));
    }
